...
cur_frm.add_fetch('projects', 'contractor_name', 'contractor_name');
cur_frm.add_fetch('projects', 'client_name', 'client_name');
cur_frm.add_fetch('projects', 'supervisorconsultant_name', 'consultant_name');
