...
function findQty(frm, child) {
    ...
    for (var i = 0; i < actLength; i++) {
        if (sheet2Table[i].initial_coordinate == child.initial_coordinate && sheet2Table[i].final_coordinate == child.final_coordinate && sheet2Table[i].meter == child.meter && sheet2Table[i].condition == "act") {
    ...
    frappe.call({
        ...
        callback: function (response) {
            ...
            for (var i = 0; i < 16; i++) {
                console.log("act array is", actArray)
