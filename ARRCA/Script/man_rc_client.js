...
frappe.ui.form.on('Man Rc Table', {
    data1: function (frm, cdt, cdn) {
        updateTotalsProduct(frm, cdt, cdn, "skilled_manpower_running_cost", "skilled_manpower_cost", 3);
    },
...
function calculateBalance(frm){
 ...
 costPerkm=routine
   ...
   var overheadCost=manpowerCost*0.15
   var operationCost=0.8*activityCost
   var expCost=manpowerCost+overheadCost
   ...
   frm.set_value("generally_running_cost",manpowerCost);
