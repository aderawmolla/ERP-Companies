...
@frappe.whitelist()
def mark_employee_attendance(employee_list, status, date, attendance_date_ec, leave_type=None, company=None):
	...
	for employee in employee_list:
		...
		attendance.attendance_date_ec = attendance_date_ec
