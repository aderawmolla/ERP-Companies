...
def create_user(employee, user = None, email=None):
	...
	return user.name
@frappe.whitelist()
def create_leave_assignment(employee, from_date=None, to_date=None):
    # If assignment doesn't exist, create a new one with default values
    emp = frappe.get_doc("Employee", employee)
    leave_assignment = frappe.new_doc("Leave Policy Assignment")
    leave_assignment.employee_name = emp.employee_name
    leave_assignment.leave_policy = emp.leave_policy
    leave_assignment.assignment_based_on = "Joining Date"
    leave_assignment.effective_from = from_date or emp.date_of_joining  # Use date_of_joining as a fallback
    leave_assignment.effective_to = to_date
    leave_assignment.employee = employee  # Set the employee field
    leave_assignment.insert()
    leave_assignment.submit()
...
def create_leave_allocation(employee, from_date=None, to_date=None):
    ...
    leave_allocation.employee_name = emp.employee_name
    leave_allocation.leave_policy = emp.leave_policy
