...
frappe.ui.form.on('Payroll Attendance Template', {
	onload: function (frm) {
        console.log("this is why not document created")
	...
	refresh: function (frm) {
		if (frm.doc.docstatus == 0) {
            console.log("process this document")
			if (!frm.is_new()) {
				frm.page.clear_primary_action();
				frm.add_custom_button(__("Process Payroll"),
					function () {
