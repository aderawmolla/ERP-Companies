...
class DeliveryNote(SellingController):
	...
	# 		remaining_qty = so_item.qty - so_item.delivered_qty
	# 		so_item.db_set('remaining_qty', remaining_qty)
	# 		frappe.db.commit()
	...
	def on_submit(self):
		...
		self.delete_linked_loading_advice()
	...
	def on_cancel(self):
        ...
        # custom function defined by Aderaw
