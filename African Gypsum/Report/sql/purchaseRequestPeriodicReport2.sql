SELECT 
  mr.name      AS "Purchase Requisition No:Link/Material Request",
  mr.transaction_date        AS	"Purchase Requisition Date",
  mr.approved_date           AS  "Purchase Requisition Approved Date",
