...
--     NULL AS "Sum Of Received Qty",
--     NULL AS "Sum Of SIV Qty",
--       Null AS "Movement by QTY", 
--     NULL AS "Received Cost",
--     NULL AS "Issue Cost",
--     Null AS "Movement by Value"
-- FROM 
--     `tabStock Entry`
...
SELECT 
  ...
  retn.qty+transIn.qty AS "Sum Of Received Qty",
  issued.count.qty + transOut.qty AS "Sum Of SIV Qty",

  retn.amount+transIn.amount AS "Received Cost",
  issued.amount + transOut.amount AS "Issue Cost",
 (issued.count + transOut.count/retn.qty+transIn.qty)*100 AS "Movement By Cost :Percent"
